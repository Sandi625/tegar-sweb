    ...
    <section class="blogs">
        <div class="blogsContainer">
            ...
            <div class="blog" id="blog">
                <img src="{{ asset('Images/IMG_4145.jpg') }}" alt="Midnight Ijen Tour from Bali" class="image" />
                <div class="content">
                    <div class="details">
                        <h2>
                        ...
                        <p class="text">
                          Tumpaksewu-Bromo-Ijen Tour (4D3N)
                        </p>
            ...
            <!-- Blog 2 -->
            <div class="blog">
                <img src="{{ asset('Images/IMG_3235.jpg') }}" alt="Midnight Ijen Tour from Banyuwangi" class="image" />
                <div class="content">
                    <div class="details">
                        <h2>
                         Tumpaksewu-Ijen-Bromo Tour (4D3N) Start From Surabaya (Finish At Surabaya)
                        </h2>
                        <p class="text">
                            Trip from Surabaya to Ijen Crater,
                            where you’ll hike under the stars, see the iconic Blue Fire, and enjoy
