    ...
    <section class="blogs">
        <div class="blogsContainer">
            ...
            <div class="blog" id="blog">
                <img src="{{ asset('Images/mada2.jpg') }}" alt="Midnight Ijen Tour from Bali" class="image" />
                <div class="content">
                    <div class="details">
                        <h2>
            ...
            <!-- Blog 2 -->
            <div class="blog">
                <img src="{{ asset('Images/IMG_4139.jpg') }}" alt="Midnight Ijen Tour from Banyuwangi" class="image" />
                <div class="content">
                    <div class="details">
                        <h2>
