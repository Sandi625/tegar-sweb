...
<section
  ...
  id="header"
  style="
    background: url('/Images/IMG_4139.jpg');
...
>
  ...
  <div class="content">
    <div class="title">
      <h1>Tumpaksewu-Bromo-Ijen Tour (4D3N) Start from Bali (finish at Bali)</h1>
    </div>
  ...
  <div class="container">
    ...
    <form id="bookingForm">
      ...
      <input
        type="text"
        id="package"
        value="Tumpaksewu-Bromo-Ijen Tour (4D3N) Start from Bali (finish at Bali)"
        readonly
      >
