...
<section
  ...
  id="header"
  style="
    background: url('/Images/IMG_3235.jpg');
...
>
  ...
  <div class="content">
    <div class="title">
      <h1>Tumpaksewu-Ijen-Bromo Tour (4D3N) Start from Surabaya (finish at Surabaya)</h1>
    </div>
...
<section class="bookingFormSection">
  <div class="container">
    ...
    <form id="bookingForm">
      ...
      <!-- Paket Trip otomatis -->
      <label for="package">Paket Trip</label>
      <input
        type="text"
        id="package"
        value="Tumpaksewu-Ijen-Bromo Tour (4D3N) Start from Surabaya (finish at Surabaya)"
        readonly
      >
      ...
      <!-- Special Request -->
      <label for="special_request">Special Request (Opsional)</label>
...
<script src="{{ asset('appmidnight.js') }}"></script>
  </body>
</html>
