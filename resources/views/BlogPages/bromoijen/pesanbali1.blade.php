...
<section
  ...
  id="header"
  style="
    background: url('/Images/IMG_5787.jpg');
...
>
  ...
  <div class="content">
    <div class="title">
      <h1>Bromo ijen tour Start from Bali (finish at Bali)</h1>
    </div>
...
<section class="bookingFormSection">
 ...
 <form id="bookingForm">
  ...
  <!-- Paket Trip otomatis -->
  <input type="text" id="package" value="Bromo Ijen Tour Start from Bali (Finish at Bali)" readonly>
