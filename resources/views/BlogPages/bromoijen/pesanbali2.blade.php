...
<section
  ...
  id="header"
  style="
    background: url('/Images/IMG_4120.jpg');
...
>
  ...
  <div class="content">
    <div class="title">
      <h1>Bromo ijen tour Start from Bali (finish at Surabaya)</h1>
    </div>
...
<section class="bookingFormSection">
 ...
 <form id="bookingForm">
  ...
  <!-- Paket Trip otomatis -->
  <input type="text" id="package" value="Bromo Ijen Tour Start from Bali (Finish at Surabaya)" readonly>
...
<script src="{{ asset('appbali.js') }}"></script>
  </body>
</html>
