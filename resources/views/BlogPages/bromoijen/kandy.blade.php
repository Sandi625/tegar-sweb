...
<section
  ...
  id="header"
  style="
    background: url('/Images/ijen1.jpg');
...
>
  ...
  <div class="content">
    <div class="title">
      <h1>Bromo ijen tour Start from Surabaya (finish at Surabaya)</h1>
    </div>
...
<p class="para one" id="para">
 ...
 <div class="para two">
  <h2>1. Itinerary Bromo Ijen Tour 3 Hari 2 Malam (Finish Surabaya)</h2>
  <hr />
  ...
  <b>Day 3 (IJEN BLUE FIRE TOUR – DROP SURABAYA)</b><br />
  ...
  salah satunya di Kawah Ijen. Setelah itu Anda bisa menikmati keindahan sunrise dari tepi kawah serta aktivitas penambang belerang.<br /><br />

  Setelah turun kembali ke pos, sarapan dan persiapan perjalanan kembali menuju Surabaya. Tour selesai di Surabaya <b>(finish tour)</b>.
</div>
...
<div class="imgDescription">
  ...
  <div class="contentContainer">
    ...
    <ol>
      <li><b>Itinerary Bromo Ijen Tour</b></li>
      <li>Dimana Menginap</li>
      <li>Hal yang Akan Dilakukan</li>
      <li>Kesimpulan</li>
    </ol>
  </div>
</section>
