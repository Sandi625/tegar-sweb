...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/blogbali.css') }}">
...
<div class="blog">
    <img src="{{ asset('Images/IMG_4120.jpg') }}" alt="Bromo Ijen Tour Surabaya" class="image" />
    <div class="content">
        <div class="details">
            <h2>
                Bromo Ijen Tour Start from Bali
                (Finish at Surabaya)
            </h2>
            <p class="text">
...
<div class="blog" id="blog">
    <img src="{{ asset('Images/IMG_5787.jpg') }}" alt="Bromo Ijen Tour Bali" class="image" />
    <div class="content">
        <div class="details">
            <h2>
                Bromo Ijen Tour Start from Bali
