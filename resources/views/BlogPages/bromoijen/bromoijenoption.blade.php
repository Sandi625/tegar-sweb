 ...
 <section class="blogs">
    <div class="blogsContainer">
        ...
        <div class="blog" id="blog">
            <img src="https://images.unsplash.com/photo-1532236395709-7d70320fec2d?ixlib=rb-1.2.1&auto=format&fit=crop&w=1078&q=80"
                alt="Tokyo Blog" class="image" />
            <div class="content">
                <div class="details">
                    <h2>
...
(finish at bali)                    </h2>
                    <p class="text">
                        Tokyo’s sheer size can be overwhelming, but with this guide,
                        you’ll explore vibrant streets, tranquil parks, stunning views,
                        and remarkable history — all in just six days!
                    </p>
        ...
        <!-- Blog 2 -->
        <div class="blog">
            <img src="https://images.unsplash.com/photo-1626091022888-485eb96c494a?ixlib=rb-1.2.1&auto=format&fit=crop&w=967&q=80"
                alt="Kandy Blog" class="image" />
            <div class="content">
                <div class="details">
                    <h2>
Bromo ijen tour Start from surabaya
(finish at surabaya)                    </h2>
                    <p class="text">
                        Kandy, Sri Lanka’s hill-country capital, is full of color:
                        bustling markets, serene temples, a beautiful lake, and rich
                        cultural heritage — all in one vibrant city.
                    </p>
                    <button class="readMoreBtn">Read more</button>
                </div>
