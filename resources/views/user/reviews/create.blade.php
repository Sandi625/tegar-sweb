...
<section class="customTripSection" style="padding:50px 20px; background:#f4f8ff;">
    <div class="customTripContainer" style="max-width:600px; margin:0 auto;">
        ...
        <form action="{{ route('user.review.store') }}" method="POST" enctype="multipart/form-data"
            class="customTripForm" style="display:flex; flex-direction:column; gap:15px;">
            @csrf
            ...
            <label for="reviewPhoto" style="font-weight:bold;">Photo (optional, you can add multiple photo)</label>
            <input type="file" id="reviewPhoto" name="photo[]" multiple
                style="width:100%; padding:10px; border-radius:6px; border:1px solid #ccc; font-size:1rem;">
